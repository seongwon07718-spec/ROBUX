...
class MeuLayout(ui.LayoutView):
    ...
    async def info_callback(self, it: discord.Interaction):
        ...
        selecao = ui.Select(placeholder="조회할 내역 선택", options=[
            discord.SelectOption(label="최근 충전 내역", value="charge", emoji="<:1302328427545624689:1480120016056619038>"),
            discord.SelectOption(label="최근 구매 내역", value="purchase", emoji="<:1302328398856847474:1480120020129419314>")
        ])
