...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @keyframes dotPulse {
      0%,100% { box-shadow: 0 0 5px rgba(88,101,242,0.7); }
      50%      { box-shadow: 0 0 14px rgba(88,101,242,1); }
    }
    @keyframes fadeUp {
    ...
    .btn-discord {
      ...
      position: relative;
      overflow: hidden;
      box-shadow: 0 4px 20px rgba(88,101,242,0.38);
    ...
    .btn-discord:hover {
      ...
      box-shadow: 0 8px 28px rgba(88,101,242,0.48);
    }
    ...
    .field input::placeholder { color: rgba(255,255,255,0.25); font-size: 14px; }
    .field input:focus {
    ...
    .terms a { color: rgba(255,255,255,0.38); text-decoration: none; }
