  ...
  <div class="svc-list">
    ...
    <div class="svc-block">
      <div class="svc-header">
        <!-- Netflix: SVG 아이콘 (base64 제거) -->
        <div class="brand-icon nf-icon">
          <svg width="28" height="28" viewBox="0 0 111 190" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 0h30l27.5 77.5L85 0h26v190h-28V95l-20 58-7.5 20L40 95v95H0V0z" fill="#E50914"/>
          </svg>
        </div>
