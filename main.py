...
class PanelLayout(discord.ui.LayoutView):
    ...
    @action_row.button(label="🛍️ 구매", style=discord.ButtonStyle.primary, custom_id="panel_buy")
    async def buy_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("🛍️ **구매** 메뉴입니다.", ephemeral=True)

    @action_row.button(label="📦 제품", style=discord.ButtonStyle.secondary, custom_id="panel_product")
    ...
    @action_row.button(label="💳 충전", style=discord.ButtonStyle.success, custom_id="panel_charge")
    ...
    @action_row.button(label="ℹ️ 정보", style=discord.ButtonStyle.secondary, custom_id="panel_info")
