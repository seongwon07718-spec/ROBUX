...
async def panel_vending(interaction: discord.Interaction):
    ...
    await interaction.response.send_message("자판기 패널이 생성되었습니다.", view=view, ephemeral=False)
